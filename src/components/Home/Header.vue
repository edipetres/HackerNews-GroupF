    ...
    <tbody>
        <tr>
            ...
            <td style="line-height:12pt; height:10px;"><span class="pagetop"><b class="hnname"><router-link to="/">Hacker News</router-link></b>
              <router-link to="/">new</router-link>| <span class="pagetop"><router-link to="/newcomments">comments</router-link></span> | <router-link to="/show">show</router-link> | <router-link to="/ask">ask</router-link> | <router-link to="/jobs">jobs</router-link> | <a href="#" @click="checkLogin">submit</a></span>
            </td>
